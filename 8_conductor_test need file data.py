...
def read_resistance(test_number):
    ...
    print(res_value)
    #offset this test reading by two, for time and counter columns
#     resistance_List[test_number+2] = res_value

    #add error checking like hard coded resitance upper and lower values
    
def read_crosstalk(test_number):
...
#open desk top meter - change ip address as needed, for different networks
rm = pyvisa.ResourceManager()
my_instrument = rm.open_resource('TCPIP0::192.168.0.43::inst0::INSTR')
my_instrument.read_termination = '\n'
#my_instrument.write('MEAS:RES? 10000 OHM')
